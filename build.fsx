...
Target "Build" (fun _ ->
  DotNetCli.Build (fun p-> { p with Project = @".\src\Serilog.Sinks.Marten.sln"
...
"Clean"
  ...
  ==> "Build"
  ==> "Test"
  =?> ("IntegrationTest", match environVarOrNone "marten_testing_database" with | Some(x) -> true | _ -> false)
  ==> "Package"
  ==> "Default"
